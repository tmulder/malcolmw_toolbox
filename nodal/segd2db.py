...
#                               ['block_length_in_bytes']
    ...
    def get_rx_coords_preplan(self):
        self.end_of_last_block += 148
        header_data = self._read_header_block(self.schema['Trace Header']\
                                                         ['32-byte Trace Header Block #5'])
        x = header_data['receiver_point_pre_plan_x_coordinate_x_10']['value']
        y = header_data['receiver_point_pre_plan_y_coordinate_x_10']['value']
        self.end_of_last_block -= 148
        return x / 10.0, y / 10.0

    def get_rx_coords_final(self):
        self.end_of_last_block += 148
        header_data = self._read_header_block(self.schema['Trace Header']\
                                                         ['32-byte Trace Header Block #5'])
        x = header_data['receiver_point_final_x_coordinate_x_10']['value']
        y = header_data['receiver_point_final_y_coordinate_x_10']['value']
        self.end_of_last_block -= 148
        return x / 10.0, y / 10.0
